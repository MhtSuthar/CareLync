...
import com.carelynk.databinding.ActivityDiscoverBinding;
 ...
 */
public class DiscoverActivity extends BaseActivity implements OnMapReadyCallback,
        ...
        binding.edtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if(binding.edtSearch.getText().length() > 0){
                    googleSearch("Diagnostic Centre");
                }else{
    ...
    private void googleSearch(String search) {
        binding.txtCategory.setText(search);
        if(search.equalsIgnoreCase("Medicine Shops"))
            search = "Pharmacy";
        else if(search.equalsIgnoreCase("Wellness Center"))
            search = "Wellness+Center";
        else if(search.equalsIgnoreCase("Yoga Center"))
            search = "Yoga+Center";
        ...
        asyncTaskGetCommon.execute("https://maps.googleapis.com/maps/api/place/textsearch/json?query="+
                search.trim().replaceAll(" ", "")+"&location="+ SharedPreferenceUtil.getString(PrefUtils.PREF_LAT, "0")+","+SharedPreferenceUtil.getString(PrefUtils.PREF_LNG, "0")+
                "&radius=1000&key="+getString(R.string.google_api_key));
    }
    ...
    private void setSearchRecyclerAdapter(List<SearchModel.Result> results) {
        ...
        SearchListAdapter searchListAdapter= new SearchListAdapter(this, results, DiscoverActivity.this);
    ...
    public void openCategoryDialog() {
        ...
        RadioGroup mRadioGroup = (RadioGroup) dialog.findViewById(R.id.rd_group);
                ...
                if(radioButton.isChecked()){
                    switch (index){
                        case 0:
                            ...
                            break;
                        case 1:
                            googleSearch("Clinics");
                            break;
                        case 2:
                            googleSearch("Doctors");
                            break;
                        case 3:
                            googleSearch("Medicine Shops");
                            break;
                        case 4:
                            googleSearch("Therapist");
                            break;
                        case 5:
                            googleSearch("Blood Bank");
                            break;
                        case 6:
                            googleSearch("Ambulance");
                            break;
                        case 7:
                            googleSearch("Wellness Center");
                            break;
                        case 8:
                            googleSearch("Yoga Center");
                            break;
                    }
                }
                dialog.dismiss();
