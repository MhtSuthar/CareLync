...
import com.carelynk.friends.adapter.MyFriendListAdapter;
...
public class MyFriendsFragment extends BaseFragment {
    ...
    private void setRecyclerAdapter(List<TimelineModel> mList) {
        ...
        myFriendListAdapter = new MyFriendListAdapter(getActivity(), mList);
        binding.recyclerView.setHasFixedSize(true);
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        binding.recyclerView.setLayoutManager(mLayoutManager);
        binding.recyclerView.setItemAnimator(new DefaultItemAnimator());
        binding.recyclerView.setAdapter(myFriendListAdapter);
    }
    ...
    private List<TimelineModel> getForum() {
        ...
        feedModel = new TimelineModel();
        feedModel.setName("Lokesh");
        mFeedList.add(feedModel);

        feedModel = new TimelineModel();
        feedModel.setName("Jacky");
        mFeedList.add(feedModel);

        feedModel = new TimelineModel();
        feedModel.setName("Akky");
        mFeedList.add(feedModel);

        feedModel = new TimelineModel();
        feedModel.setName("Mukesh");
        mFeedList.add(feedModel);

        feedModel = new TimelineModel();
        feedModel.setName("Jaani");
        mFeedList.add(feedModel);
        return mFeedList;
    }
