...
public class FollowingFragment extends Fragment {
    ...
    private FollowingDashboardRecyclerAdapter followingDashboardRecyclerAdapter;
    ...
    void setAdapter(){
        followingDashboardRecyclerAdapter = new FollowingDashboardRecyclerAdapter(FollowingFragment.this, mList);
        binding.recyclerView.setHasFixedSize(true);
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        binding.recyclerView.setLayoutManager(mLayoutManager);
        binding.recyclerView.setItemAnimator(new DefaultItemAnimator());
        binding.recyclerView.setAdapter(followingDashboardRecyclerAdapter);
    }


    public void setmList(List<DashboardModel.FollowingArray> mList) {
        this.mList = mList;
    }
