 ...
 */
public class ArticleDashboardRecyclerAdapter extends RecyclerView.Adapter<ArticleDashboardRecyclerAdapter.ViewHolder> {

    private List<DashboardModel.ArticleArray> mList;
    private ArticleFragment mContext;
    ...
    public ArticleDashboardRecyclerAdapter(ArticleFragment context, List<DashboardModel.ArticleArray> mListPatient) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.txtName.setText(Html.fromHtml(mList.get(position).getArticle()));
