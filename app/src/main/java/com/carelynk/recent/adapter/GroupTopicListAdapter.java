 ...
 */
public class GroupTopicListAdapter extends RecyclerView.Adapter<GroupTopicListAdapter.ViewHolder> {
    ...
    public GroupTopicListAdapter(Context context, List<TimelineModel> mListPatient) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_group_topic, parent, false);
