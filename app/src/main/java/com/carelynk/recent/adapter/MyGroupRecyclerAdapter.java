...
import com.carelynk.databinding.ListItemMyGroupBinding;
...
public class MyGroupRecyclerAdapter extends RecyclerView.Adapter<MyGroupRecyclerAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private ListItemMyGroupBinding binding;

        public ViewHolder(View rowView) {
            super(rowView);
            binding = DataBindingUtil.bind(rowView);
        }
        public ListItemMyGroupBinding getBinding() {
            return binding;
        }
    }

    public MyGroupRecyclerAdapter(Context context, List<TimelineModel> mListPatient) {
